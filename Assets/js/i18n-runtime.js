...
(function () {
  ...
  var RULES = [
    ...
    [/^Die Passkey-Anmeldung wurde abgebrochen — oder auf diesem Gerät liegt noch keiner für MyWorkLog\. Richte ihn einmalig in den Einstellungen unter Cloud ein\.$/g,
      'Passkey sign-in was cancelled \u2014 or this device has no passkey for MyWorkLog yet. Set one up once under Settings \u2192 Cloud.'],
    [/^Dieser Passkey gehört zu keinem Konto hier\. Melde dich einmal anders an und richte ihn danach neu ein\.$/g,
      'This passkey does not belong to an account here. Sign in another way once, then set it up again.'],
    [/^Für dieses Gerät gibt es hier schon einen Passkey\.$/g, 'This device already has a passkey here.'],
    [/^Der Vorgang hat zu lange gedauert\. Versuch es noch einmal\.$/g, 'That took too long. Please try again.'],
    [/^Für dieses Konto sind bereits die maximal möglichen Passkeys eingerichtet\.$/g,
      'This account already has the maximum number of passkeys.'],
    [/^Passkeys sind für dieses Konto gerade nicht verfügbar\.$/g, 'Passkeys are currently unavailable for this account.'],
    [/^Passkeys werden auf diesem Gerät nicht unterstützt$/g, 'This device does not support passkeys'],
    [/^Zum Einrichten eines Passkeys musst du angemeldet sein$/g, 'You must be signed in to set up a passkey'],
    [/^Passkey eingerichtet: (.+)\. Beim nächsten Anmelden reicht jetzt Fingerabdruck oder Gesicht\.$/g,
      'Passkey set up: $1. Next time, your fingerprint or face is enough.'],
    [/^Passkey eingerichtet\. Beim nächsten Anmelden reicht jetzt Fingerabdruck oder Gesicht\.$/g,
      'Passkey set up. Next time, your fingerprint or face is enough.'],
    [/^Passkey entfernt\. Im Schlüsselbund deines Geräts liegt er weiterhin — dort musst du ihn getrennt löschen\.$/g,
      'Passkey removed. It still exists in your device keychain \u2014 delete it there separately.'],
    [/^Noch keiner eingerichtet\.$/g, 'None set up yet.'],
    [/^Warte auf Bestätigung…$/g, 'Waiting for confirmation\u2026'],
    [/^Entfernen$/g, 'Remove'],
    [/^seit (.+)$/g, 'since $1'],
