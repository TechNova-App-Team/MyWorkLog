...
const TRIVIAL = [
  ...
  /^(MyWorkLog|GitHub|IHK|JAV|BBiG|JArbSchG|ArbZG|BUrlG|AGG|EntgFG|DSGVO|BDSG|TDDDG|DDG|MStV|DSA|PDF|CSV|JSON|TXT|XML|API|PWA|AES|PBKDF2|SHA|HTML|CSS|JS|TS|MIT|EU|USA|DE|EN|OK|ID|URL|E-Mail|Email|Info|Status|Update|Updates|Feedback|Import|Export|Timer|Chat|Cloud|Server|Browser|Session|Sessions|Dashboard|Support|Analytics|Performance|Backup|Backups|Sync|Reset|Standard|Basic|Pro|Premium|Start|Stop|Pause|Team|Tool|Tools|Links|Details|Version|Beta|Setup|Login|Logout|Look|Modern|Minimal|Kompakt|Total|Prompt|Token|Tokens|Web|App|Apps|Icon|Icons|Menu|Modal|Header|Footer|Sidebar|Grid|Chart|Charts|Report|Reports|Editor|Manager|Monitor|Scanner|Tracker|Terminal|Galaxy|Quantum|Radar|Matrix|Level|XP|Skill|Skills|Quiz|Karma|Combo|Streak|Highscore|Ranking|Score|Online|Offline|Auto|Live|Name|Symbol|Position|Optional|Neutral|Uptime|Endpoints|Events|Engagement|Channel|Channels|Referrers|OS|LCP|Bounce|Jobs|Custom Fields|Workflow Rules|Recovery Center|Cloud Login|Cloud Sync|Discord|Google|Supabase|PayPal|EmailJS|Cloudflare|PostHog|Groq|Nominatim|OSRM|Komoot|FlixBus|BlaBlaCar|Deutsche Bahn|Google Maps|Deutschlandticket|Academy|Frontend|Backend|DevOps|Security|Cheat Sheets|Branch|Graph|Files|Groups|Hierarchy|ArchFlow|Changelog|Navigation|Kontakt)$/i,
